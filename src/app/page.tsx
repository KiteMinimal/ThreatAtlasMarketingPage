...
export default function Home() {
  return (
    <div className="bg-black text-white min-h-screen flex flex-col justify-between scroll-smooth">
      ...
      >
        <div className="max-w-6xl mx-auto space-y-20">
          {advantages.map((advantage, index) => (
            <div key={advantage.title} className={`grid md:grid-cols-2 gap-12 items-center ${index % 2 !== 0 ? 'md:grid-flow-col-dense' : ''}`}>
              <motion.div 
      ...
      >
        <img src="/64b8d16d96243d6341ddbec4_red code alert (2).jpeg" alt="Alert Icon" className="w-24 h-24 mx-auto mb-6 rounded-full shadow-lg border-4 border-gray-700" />
        <h3 className="text-3xl font-bold mb-4">Ready to Strengthen Your Security?</h3>
        <p className="text-lg text-gray-400 max-w-2xl mx-auto mb-8">
          See ThreatIntel Pro in action. Schedule a personalized demo with our experts today.
        </p>
        <motion.a
            href="#"
            className="bg-gradient-to-r from-blue-500 to-purple-600 px-10 py-4 rounded-full font-semibold text-white text-lg transition-transform shadow-lg"
